...
<head>
  ...
  <title>Dashboard Admin - Tickema</title>
...
<main>
  <div class="dashboard-container">
    ...
    <div class="gestione-section">
      <h2 class="section-title">Gestione Sistema</h2>
      ...
      <div class="actions-grid">
        ...
        <a href="${pageContext.request.contextPath}/admin/utenti"
          ...
          <div class="action-info">
            <h3 class="action-title">Visualizzazione Utenti</h3>
            <p class="action-description">
              Consulta la lista completa di tutti gli utenti registrati al sistema
            </p>
            <span class="action-link">Visualizza utenti</span>
          </div>
        </a>
        ...
        <a href="${pageContext.request.contextPath}/film?action=admin-lista"
          ...
          <div class="action-info">
            <h3 class="action-title">Gestione Catalogo</h3>
            <p class="action-description">
              Crea, modifica e visualizza i dettagli dei film nel catalogo
            </p>
            <span class="action-link">Gestisci catalogo</span>
          </div>
        </a>
        ...
        <a href="${pageContext.request.contextPath}/admin/programmazione?action=lista"
          ...
          <div class="action-info">
            <h3 class="action-title">Gestione Programmazioni</h3>
            <p class="action-description">
              Crea, modifica e visualizza le programmazioni dei film nelle sale
            </p>
            <span class="action-link">Gestisci programmazioni</span>
          </div>
        </a>
        ...
        <a href="${pageContext.request.contextPath}/admin/gestione-acquisti"
          ...
          <div class="action-info">
            <h3 class="action-title">Gestione Acquisti</h3>
            <p class="action-description">
              Visualizza e gestisci tutti gli acquisti e i biglietti del sistema
            </p>
            <span class="action-link">Gestisci acquisti</span>
          </div>
        </a>
      </div>
    </div>
